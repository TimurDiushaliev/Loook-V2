...
class AddPriceTextFieldAndCurrencyDropDownButton extends StatelessWidget {
  ...
  AddPriceTextFieldAndCurrencyDropDownButton({@required this.price});
  @override
  Widget build(BuildContext context) {
    AdvertDetailsBloc _advertDetailsBloc = BlocProvider.of<AdvertDetailsBloc>(context);
    return Row(
          ...
          builder: (context, state){
            ...
            child: DropdownButton(
              ...
              onChanged: (value) {
                ...
                _advertDetailsBloc.add(AddDetailEvent(advertDetail: {'currency': value}));
              },
              items: [
