...
class AdvertDetailsBottomSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<AdvertDetailsBottomSheetBloc,
        AdvertDetailsBottomSheetStates>(
      builder: (context, state) {
        return NotificationListener<DraggableScrollableNotification>(
          onNotification: (notification) {
            notification.extent == 1.0
                ? BlocProvider.of<AdvertDetailsBottomSheetBloc>(context)
                    .add(AdvertDetailsWithUsualCornersEvent())
                : BlocProvider.of<AdvertDetailsBottomSheetBloc>(context)
                    .add(AdvertDetailsWithRoundedCornersEvent());
          },
          child: DraggableScrollableSheet(
            ...
            builder: (context, scrollController) {
              return Container(
                decoration: state is AdvertDetailsWithRoundedCornersState
